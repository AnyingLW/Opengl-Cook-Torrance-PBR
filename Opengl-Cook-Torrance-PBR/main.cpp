...
int main() {
	...
	Shader depthShader("shaders/lightShader.vs", "shaders/lightShader.fs");
	Shader debugDepthQuad("shaders/quadShader.vs", "shaders/quadShader.fs");
	...
	unsigned int woodTexture = loadTexture("resource/wall.jpg");
